...
class Macronutrients():
    pfcc = {
        ...
        "котлета": (10.1, 19.4, 3.3, 227.4),
        "гречка": (12.6, 3.3, 68, 313),
        "салат": (1.32, 4.9, 3.3, 62.4),
    }
...
lunch_12_00 = Meal("обед 12:00", [("суп", 400), ("яблоко", 150)])
...
snack_15_00 = Meal("полдник 15:00", [("курица", 200), ("помидор", 200)])

####################################################################################################
# DINNER ###########################################################################################
####################################################################################################

dinner_19_00 = Meal("ужин 19:00", [("гречка", 30), ("котлета", 200), ("салат", 200)])
...
if __name__ == "__main__":
    meals = [breakfast_08_00, lunch_12_00, snack_15_00, dinner_19_00, dinner_21_00]
