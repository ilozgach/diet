...
breakfast_1 = Meal("завтрак 1", [("овсянка", 35), ("молоко 3.2%", 270), ("шоколад", 25)])
...
dinner_1 = Meal("ужин 1", [("крабовый салат", 200), ("ржаной хлеб", 50)])
dinner_2 = Meal("ужин 2", [("творог 9%", 90), ("мед", 20), ("кешью", 10)])
...
if __name__ == "__main__":
    meals = [breakfast_1, breakfast_2, lunch_1, snack_1, dinner_1, dinner_2]
